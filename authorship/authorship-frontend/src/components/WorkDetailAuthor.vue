    ...
    <div class="page-layout-grid">
      ...
      <div class="right-column-sidebar">
        <div class="container-card sidebar-card-info" v-if="work">
          ...
          <div class="file-box-section">
            <div v-if="work?.resume_name" class="sub-file-box" style="margin-bottom: 20px;">
              <span class="label-sidebar-title">
                <i class="fa-solid fa-eye"></i> Muestra Gratuita Activa
              </span>
            ...
            <div v-if="work?.file_name" class="sub-file-box">
              <span class="label-sidebar-title">
                <i class="fa-solid fa-box-archive"></i> Tu Obra Original
              </span>
              <p class="sidebar-help-text">
